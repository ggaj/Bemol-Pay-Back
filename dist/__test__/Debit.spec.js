...
describe('Transaction', function () {
    ...
    it('should be able create new debit transaction', function () { return __awaiter(void 0, void 0, void 0, function () {
        var session, debit;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    session = _a.sent();
                    return [4 /*yield*/, supertest_1.default(app_1.default).post('/debits').set('Authorization', "Bearer " + session.body.token).send({
                            id: Date.now(),
                            name: "Gildo Jr",
                            type: "DebitCard",
                            amount: 1000,
